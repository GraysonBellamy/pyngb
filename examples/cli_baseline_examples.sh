...
echo "pyngb convert sample.ngb-ss3 -b baseline.ngb-bs3"
echo "   → Creates: sample_baseline_subtracted.parquet"
echo

# Example 2: Custom output directory
echo "2. Baseline subtraction with custom output directory:"
echo "pyngb convert sample.ngb-ss3 -b baseline.ngb-bs3 -o ./corrected_data/"
...
echo "        pyngb convert \"\$file\" -b \"\$baseline\" -o ./results/"
echo "    fi"
echo "done"
echo
...
echo "pyngb convert sample.ngb-ss3 -b baseline.ngb-bs3 --dynamic-axis sample_temperature -o ./temp_axis/"
echo "pyngb convert sample.ngb-ss3 -b baseline.ngb-bs3 --dynamic-axis time -o ./time_axis/"
echo "pyngb convert sample.ngb-ss3 -b baseline.ngb-bs3 --dynamic-axis furnace_temperature -o ./furnace_axis/"
echo

# Example 8: Error handling
echo "8. The CLI provides helpful error messages:"
echo "pyngb convert nonexistent.ngb-ss3 -b baseline.ngb-bs3"
echo "   → Error: Input file does not exist"
echo
echo "pyngb convert sample.ngb-ss3 -b nonexistent.ngb-bs3"
echo "   → Error: Baseline file does not exist"
echo

echo "=== Other Subcommands ==="
echo "pyngb convert sample.ngb-ss3     # Process without baseline (normal mode)"
echo "pyngb inspect sample.ngb-ss3     # Show file structure and coverage"
echo "pyngb validate sample.ngb-ss3    # Run data-quality checks"
echo "pyngb --help                     # List subcommands; pyngb convert --help for options"
echo
...
echo "https://pyngb.graysonbellamy.dev/"
