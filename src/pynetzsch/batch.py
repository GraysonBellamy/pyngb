...
from pynetzsch.api.loaders import get_sta_data
from pynetzsch.constants import FileMetadata
...
class NGBDataset:
    ...
    Examples:
        >>> from pynetzsch.batch import NGBDataset
        >>>
...
def process_directory(
    ...
    Examples:
        >>> from pynetzsch.batch import process_directory
        >>>
