#!/usr/bin/env python3
"""
Enhanced command-line interface for PyNetzsch.
"""
...
from pynetzsch import __version__, get_sta_data, load_ngb_data
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="PyNetzsch - Parse NETZSCH STA NGB files",
        epilog="Examples:\n"
        "  pynetzsch sample.ngb-ss3\n"
        "  pynetzsch *.ngb-ss3 -o output_dir/\n"
        "  pynetzsch sample.ngb-ss3 -f csv --metadata-only\n",
